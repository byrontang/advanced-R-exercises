...
t.test(1:10, y = c(7:20)) # throws an error
...
Math
# Math() calls standardGeneric("Math")
...
```{r}
# The code creates two generic funtions, g() and h(), and methods for each generic.
...
```{r}
# The class of f is implicit while the class of g is explicitly assigned.
# Therefore, althought both f and g have the class of funciton,
# passing f to length(), a primitive generic function, 
# would not dispatch a method, but
# passing g to length() would dispatch length.function() 
