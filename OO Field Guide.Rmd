...
Reference: https://www.rdocumentation.org/packages/methods/versions/3.5.0/topics/ReferenceClasses")
```
...
```{r}
message("envRefClass: All reference classes eventually inherit from envRefClass.
