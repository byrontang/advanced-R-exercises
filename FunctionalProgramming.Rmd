...
```{r}
# Create function
integrationFuns <- function(f, a, b, n = 10, rule = "midpoint", 
                            coef = c(7, 32, 12, 32, 7), 
                            open = FALSE){
  ...
  functions <- list(
    ...
    boole <- newton_cotes(coef = coef, open = open),
    milne <- newton_cotes(coef = coef, open = open)
  )
...
message("milne: ", 
        integrationFuns(sin, 0, pi, rule = "milne", 
                        coef = c(2, -1, 2), open = TRUE))
```
